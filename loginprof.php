                  ...
                  <div class="container">
                      ...
                      <div id="navbar" class="navbar-collapse collapse">
                          <ul class="nav navbar-nav">
                              ...
                              <li><a href="parents.php" id="ii2">Parents</a></li>
                               ...
                               <li class="dropdown"><a href="" class="dropdown-toggle " data-toggle="dropdown" id="i2">Enseignants<span class="caret"></span></a>
                                  <ul class="dropdown-menu">
                                      ...
                                      <li><a href="profs.php" id="i5">Enseignant card</a></li>
                                  </ul>
                              </li>
      ...
      <div class="container-fluid" style="margin-top: 5em;">
        <div class="row content">
          ...
          <ul class="breadcrumb">
            ...
            <hr>
            <h2></h2>
            <h2 style="color: #2e3482">Espace Privé</h2><br>
            <h4 style="color: #09ba32;">Veuillez entrer vos identifiants</h4>
             <div class="col-sm-8" style="margin-top: 2em;margin-left: 7em;">
          <form class="form-horizontal" action="log.php" method="post" id="contact_form">
            <fieldset>
            ...
            <div class="form-group">
                <div class="col-md-12">
                  <button type="submit" class="btn btn-warning pull-right" name="ok">Connecter</button>
                </div>
              </div>
            </fieldset>
          </form>
