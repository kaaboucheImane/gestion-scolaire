                  ...
                  <div class="container">
                      ...
                      <div id="navbar" class="navbar-collapse collapse">
                          <ul class="nav navbar-nav">
                              ...
                              <li class=" dropdown"><a href="emploi.php" class="dropdown-toggle " data-toggle="dropdown"  id="i4">Elèves <span class="caret"></span></a>
                                  <ul class="dropdown-menu">
                                      <li><a href="emploi.php" id="i4">Documents Pratiques</a></li>
                                      
                                  </ul>
                              </li>
                              <li><a href="parents.php" id="i4">Parents</a></li>
                              <li class="dropdown"><a href="" class="dropdown-toggle " data-toggle="dropdown"  id="i2">Enseignants<span class="caret"></span></a>
                                  <ul class="dropdown-menu">
                                      <li><a href="loginprof.php" id="i4">Espace Enseignant</a></li>
                                      <li><a href="profs.php" id="i2">Enseignant card</a></li>
                                  </ul>
                              </li>
                               
                               <li><a href="activite.php" id="i7">Activités Parascolaires</a></li>
                          </ul>
          ...
          <div class="col-sm-9" style="">
            ...
            <div class="panel-group" id="accordion">
             <div class="panel panel-success">
              ...
              <?php
                ...
                $res=mysqli_query($con,$sql);
                while($rows=mysqli_fetch_array($res)) {
                  if ($rows['niveau']=="Maternelle") {

              ?>

           
              <table class="table table-striped" style="width: 8em; float: left;">
                  <tr>
                    <th>
                      <img src="profimg/<?php echo $rows['image'];?>" style="width:15em; height: 15em;">
                    </th>

                    <td>

                      <h3><?php echo $rows['nom']." ".$rows['prenom'];?></h3>
                      <p class="title"><?php echo"Prof d' ".$rows['profde'];?></p>
                      <p><?php echo $rows['niveau']." ".$rows['annee']." année";?></p>
                      <p><?php echo $rows['gmail'];?></p>
                    </td>
                  </tr>
           ...
           <div class="panel-group" >
             <div class="panel panel-success">
              ...
              <table border style="float: left; text-align: center; border:white; border: 3em;">
                <thead>
                  <tr>
                    <th>
                      <img src="profimg/<?php echo $rows['image'];?>" style="width:15em; height: 15em;">
           ...
           <div class="panel-group" >
             <div class="panel panel-success">
               <div class="panel-heading">
                <h4 class="panel-title">
                <a data-toggle="collapse" data-parent="#accordion" href="#collapse4">Lycée</a>
                </h4>
               </div>
