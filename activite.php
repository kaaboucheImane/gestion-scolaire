...
<head>
  ...
  <title>Activités Parascolaires-Aya Al Madina</title>
  <meta charset="utf-8">
                ...
                <div class="container">
                    ...
                    <div id="navbar" class="navbar-collapse collapse">
                        ...
                        <ul class="nav navbar-nav pull-right">
                            <li ><a href="inscription.php" id="i8">Inscription</a>
                ...
                <div class="col-md-3 col-sm-4">
                  <div class="wrimagecard wrimagecard-topimage">
                      <div class="wrimagecard-topimage_header" style="background-color: rgba(22, 160, 133, 0.1)">
                        ...
                        <img id="im" src="cool/<?php echo $rows['image'];?>" style="width:100%; height:12em;">
                       
                      </div>
                      <div class="wrimagecard-topimage_title" style="margin-left:0.5em; margin-top: 0.5em;">
                        <p><i class="far fa-clock"></i>
                        <small><i class="fa fa-clock-o" aria-hidden="true"></i><?php echo"\t".$rows['date'];?></small></p>
