...
<html lang="en">
<head>
  <title>Activité Parascolaire-Aya Al Madina</title>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="stylesheet" type="text/css" href="css/actparascolair.css">
                ...
                <div class="container">
                    ...
                    <div id="navbar" class="navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="active"><a href="activite.php" id="i5">Activité Parascolaire</a></li>
    ...
    <div class="container-fluid" style="margin-top: 5em;">
      <div class="row content">
        ...
        <?php
            ...
            $con=mysqli_connect('localhost','root','','groupescolaire');
            $id=$_GET['id'];
            $sql="SELECT*FROM activitetab where id='$id'";
            $res=mysqli_query($con,$sql);
          ...
          <h2></h2>
              ...
              <div class="thumbnail principal-post">
                 ...
                 <?php
                  ...
                  $id=$_GET['id'];
                  $time=$_GET['time'];
                  $sql="SELECT *FROM activiteimage where date='$time'";
                  $res=mysqli_query($con,$sql);
                  ?>
              ...
              <h3>Galerie </h3>
               <hr style="width: 5em;height:0.3em; background-color: red; margin-left:-0.1em; margin-top: -0.5em;">
                 ...
                 <?php
                  ...
                  $id=$_GET['id'];
                  $time=$_GET['time'];
                  $sql="SELECT *FROM activitevideo where date='$time'";
                  $res=mysqli_query($con,$sql);
                  ?>
                      ...
                      <div class="row">
                          <div id="fb-root"></div>
                            ...
                            <div class="fb-video" data-href="https://www.facebook.com/ayaalmadina17.18/videos/<?php echo $rows['code'];?>/" data-width="300"  data-show-text="false" style="margin-left: 2em;">
                              <div class="fb-xfbml-parse-ignore">
                                <blockquote cite="https://www.facebook.com/ayaalmadina17.18/videos/<?php echo $rows['code'];?>/">
                                  <a href="https://www.facebook.com/ayaalmadina17.18/videos/<?php echo $rows['code'];?>/">How to Share With Just Friends</a>
                                  <p>How to share with just friends.</p>
                                  Posted by <a href="https://www.facebook.com/ayaalmadina17.18/">Facebook</a> 
                      ...
                      <div style="height:4em; "></div>
                       ...
                       <span><a href="activite.php"><i class="fa fa-arrow-left" aria-hidden="true"></i></a></span>
                </div>  
              </div>
              
              <div class="col-sm-4 col-md-4">
                    <h3>Recent activité</h3>
                    <div>
                     <hr style="width: 5em;height:0.3em; background-color: red; margin-left:-0.1em; margin-top: -0.5em;">
                     <hr style="width: 13em; margin-top: -1.5em; margin-right: 2em;">
                      ...
                      <?php
                         ...
                         $con=mysqli_connect('localhost','root','','groupescolaire');
                         $sql="SELECT*FROM activitetab ORDER BY date DESC";
                         $res=mysqli_query($con,$sql);
                       ...
                       ?>
                       <div class="thumbnail">
                          <?php echo "<a href='activiteparascolaire.php?id=$id && time=$time'>";?>
                             <div class="caption">
                                <h3><?php echo $rows['titre'];?></h3>
                                <span class="date-of-post"><h4><small><i class="fa fa-clock-o" aria-hidden="true"></i><?php echo"\t".$rows['date'];?></p></small></h4></span>
                             </div>
