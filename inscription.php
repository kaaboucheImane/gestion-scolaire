...
<html lang="en">
<head>
  <title>Inscription-Aya Al Madina</title>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="stylesheet" type="text/css" href="css/inscri.css">
    ...
    <div class="container-fluid" style="margin-top: 5em;">
      <div class="row content">
        ...
        <div class="col-sm-9">
          ...
          <div class="col-sm-9 col-md-6 col-lg-8" id="box" style=" margin-top: 5em; background-color: white;">
            
              <form class="form-horizontal" action="ins.php" method="post" id="contact_form">
                <fieldset><legend><center><h3 style="color: #55517f;" ><i class="fa fa-quote-left" aria-hidden="true" style="color: red;"></i>  Places limitées! Dépechez-vous.  <i class="fa fa-quote-right" aria-hidden="true" style="color: red;"></i></h3></center></legend>
                  <div class="form-group">
                    <div class="col-md-12">
                      <div class="input-group">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-user" style="color: #28235d;"></i></span>
                        <input  placeholder="Nom/Prenom" class="form-control" type="text" name="nom">
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-md-12">
                      <div class="input-group">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-envelope" style="color:#f39610;"></i></span>
                  ...
                  <div class="form-group">
                    <div class="col-md-12">
                      <div class="input-group">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-earphone" style="color: green;"></i></span>
                  ...
                  <div class="form-group">
                    <div class="col-md-12">
                      <button type="submit" class="btn btn-warning pull-right" name="ok">Réserver </button>
                    </div>
                  </div>
                </fieldset>
              </form>
