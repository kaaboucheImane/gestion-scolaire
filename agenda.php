...
<html lang="en">
<head>
  <title>Agenda-Aya Al Madina</title>
  <meta charset="utf-8">
      ...
      <div class="row content">
        ...
        <div class="col-sm-9">
          ...
          <?php
            while($rows=mysqli_fetch_array($res)) {
          ?> 
          <h2 style="color: #2e3482;"><?php echo $rows['titre'];?></h2>
          <small><i class="fa fa-clock-o" aria-hidden="true"></i> <?php echo $rows['date'];?></small><br><br>
