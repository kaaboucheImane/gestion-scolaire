...
<body style=" ">
  ...
  <div class="container-fluid" style="margin-top: 5em;">
    ...
    <div class="col-sm-8" style="margin-top: 2em;margin-left: 7em;">
         <br>
      <form class="form-horizontal" action="logparent.php" method="post" id="contact_form">
        <fieldset>
        ...
        <div class="form-group">
            <div class="col-md-12">
              <button type="submit" class="btn btn-warning pull-right" name="ok">Connecter</span></button>
            </div>
          </div>
        </fieldset>
      </form>
