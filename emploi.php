...
<html lang="en">
<head>
  <title>Documents Pratiques-Aya Al Madina</title>
  <meta charset="utf-8">
                  ...
                  <div class="container">
                      ...
                      <div id="navbar" class="navbar-collapse collapse">
                          <ul class="nav navbar-nav">
                              ...
                              <li class=" dropdown" id="active" ><a href="#" class="dropdown-toggle " data-toggle="dropdown">Elèves <span class="caret"></span></a>
                                  <ul class="dropdown-menu">
                                      <li id="active"><a href="emploi.php" >Documents Pratiques </a></li>
                                  </ul>
                              </li>
                          ...
                          <ul class="nav navbar-nav pull-right">
                              ...
                              <li ><a href="contact.php" id="i8">Contact</a></li>
                          </ul>
                      </div>
                  </div>
              </nav>
        ...
        <div class="row content">
                      ...
                      <div class="item active">
                          ...
                          <div class="carousel-caption" style="background-color: black;opacity: 0.5;color: white;">
                              ...
                              <p class="carousel-caption-text hidden-sm hidden-xs">
                                 <?php echo "<a href='activiteparascolaire.php?id=$id && time=$time' style='color:white;'>» Lire la suite</a>"?>
                              </p>
                          </div>
                      </div>
                      <?php }$i++;}
          ...
          <small>
              <ul class="breadcrumb" >
                ...
                <li class="active">Documents Pratiques</li>
              </ul>
           </small>
           <hr>
           <h4><small>Emploi du temps</small></h4>
              <div>
                <hr style="width: 4em;height:0.2em; background-color: red; margin-left:-0.1em; margin-top: -0.5em;">
              </div>
          ...
          <div class="panel panel-success">
            <div class="panel-heading">
              <h4 class="panel-title">
                <a data-toggle="collapse" data-parent="#accordion" href="#collapse1">Maternelle</a>
              </h4>
            </div>
          ...
          <div class="panel panel-success">
            <div class="panel-heading">
              <h4 class="panel-title">
                <a data-toggle="collapse" data-parent="#accordion" href="#collapse2">Primaire</a>
              </h4>
            </div>
            <div id="collapse2" class="panel-collapse collapse">
              <div class="panel-body">
               <table class="table table-striped">
                  ...
                  $res=mysqli_query($con,$sql);
                  while($rows=mysqli_fetch_array($res)) {
                  if($rows['annv']=="Primaire"){
                    echo "<tr><td>";
                    ?><a href="cool/<?php echo $rows['pdf'];?>" style="text-decoration: none;"><i class="fa fa-file-pdf-o" aria-hidden="true" style="color: red;"></i></a><?php
                    echo "</td><td>".$rows['sm']."</td></tr>";
                  }
                }
                ?>
          ...
          <div class="panel panel-success">
            <div class="panel-heading">
              <h4 class="panel-title">
                <a data-toggle="collapse" data-parent="#accordion" href="#collapse3">Collège</a>
              </h4>
            </div>
            ...
            <div class="panel-heading">
              <h4 class="panel-title">
                <a data-toggle="collapse" data-parent="#accordion" href="#ha1">Lycée</a>
              </h4>
            </div>
            <div id="ha1" class="panel-collapse collapse">
              <div class="panel-body">
               <table class="table table-striped">
                    <thead>
                      <tr>
                  ...
                  if($rows['annv']=="Lycée"){
                    echo "<tr><td>";
                    ?><a href="cool/<?php echo $rows['pdf'];?>" style="text-decoration: none;"><i class="fa fa-file-pdf-o" aria-hidden="true" style="color: red;"></i></a><?php
                    echo "</td><td>".$rows['sm']."</td><td>".$rows['filiere']."</td></tr>";
                  }
                }
                ?>
      ...
      <!--**************************-->
       <div class="col-sm-9">
          ...
          <div class="panel panel-success">
            <div class="panel-heading">
              <h4 class="panel-title">
                <a data-toggle="collapse" data-parent="#accordion" href="#collaps2">Primaire</a>
              </h4>
            </div>
            <div id="collaps2" class="panel-collapse collapse">
              <div class="panel-body">
               <table class="table table-striped">
                    <thead>
                      <tr>
                       <th>Fichier pdf a téléchager</th>
                  ...
                  $res=mysqli_query($con,$sql);
                  while($rows=mysqli_fetch_array($res)) {
                  if($rows['niveau']=="Primaire"){
                    echo "<tr><td>";
                    ?><a href="cool/<?php echo $rows['pdf'];?>" style="text-decoration: none;"><i class="fa fa-file-pdf-o" aria-hidden="true" style="color: red;"></i></a><?php
                    echo "</td><td>".$rows['niveau']."</td><td>".$rows['anneesc']."</td><td>".$rows['semestre']."</td><td>".$rows['date']."</td></tr>";
                  }
                }
                ?>
          ...
          <div class="panel panel-success">
            <div class="panel-heading">
              <h4 class="panel-title">
                <a data-toggle="collapse" data-parent="#accordion" href="#collaps3">Collège</a>
              </h4>
            </div>
            ...
            <div class="panel-heading">
              <h4 class="panel-title">
                <a data-toggle="collapse" data-parent="#accordion" href="#ha53">Lycée</a>
              </h4>
            </div>
            <div id="ha53" class="panel-collapse collapse">
              <div class="panel-body">
               <table class="table table-striped">
                    <thead>
                      <tr>
                  ...
                  $res=mysqli_query($con,$sql);
                  while($rows=mysqli_fetch_array($res)) {
                  if($rows['niveau']=="Lycée"){
                    echo "<tr><td>";
                    ?><a href="cool/<?php echo $rows['pdf'];?>" style="text-decoration: none;"><i class="fa fa-file-pdf-o" aria-hidden="true" style="color: red;"></i></a><?php
                    echo "</td><td>".$rows['niveau']."</td><td>".$rows['anneesc']."</td><td>".$rows['filiere']."</td><td>".$rows['semestre']."</td><td>".$rows['date']."</td></tr>";
                  }
                }
                ?>
        ...
        <div class="col-sm-9">
            <h4><small>Fournitures</small></h4>
               <div>
                <hr style="width: 4em;height:0.26em; background-color: red; margin-left:-0.1em; margin-top: -0.5em;">
              </div>
            <div class="panel-group" id="accordion">
          <div class="panel panel-success">
            <div class="panel-heading">
              <h4 class="panel-title">
                <a data-toggle="collapse" data-parent="#accordion" href="#collap1">Maternelle</a>
              </h4>
            </div>
          ...
          <div class="panel panel-success">
            <div class="panel-heading">
              <h4 class="panel-title">
                <a data-toggle="collapse" data-parent="#accordion" href="#collap2">Primaire</a>
              </h4>
            </div>
                    ...
                    <tbody>
                      <?php
                        ...
                        while($rows=mysqli_fetch_array($res)) {
                         if($rows['annv']=="Primaire"){
                         echo "<tr><td>";
                         ?><a href="cool/<?php echo $rows['pdf'];?>" style="text-decoration: none;"><i class="fa fa-file-ptrue" style="color: red;"></i></a><?php
                         echo "</td><td>".$rows['sm']."</td></tr>";
                        }
                       }
                      ?>
          ...
          <div class="panel panel-success">
            <div class="panel-heading">
              <h4 class="panel-title">
                <a data-toggle="collapse" data-parent="#accordion" href="#collap3">Collège</a>
              </h4>
            </div>
            ...
            <div class="panel-heading">
              <h4 class="panel-title">
                <a data-toggle="collapse" data-parent="#accordion" href="#ha55">Lycée</a>
              </h4>
            </div>
            <div id="ha55" class="panel-collapse collapse">
              <div class="panel-body">
                  <table class="table table-striped">
                    <thead>
                      <tr>
        ...
        <div class="row">
            <div class="col-sm-4">
             <div class="panel panel-success">
               <div class="panel-heading"><h4><center>Rentrée scolaire</center></h4></div>
               <?php
                   $con=mysqli_connect('localhost','root','','groupescolaire');
                ...
                ?>
               <div class="panel-body"><p><strong><center><?php echo $rows['jr1']."-".$rows['jr2']; ?>:</strong><?php echo " ". $rows['time1']." à ".$rows['time2'] ;}?></p></center></div>
              </div>
             </div>
             <div class="col-sm-4">
               <div class="panel panel-success">
                 <div class="panel-heading"><h4><center>Calendrier des vacances scolaires</center></h4></div>
                  <div class="panel-body">
                  <?php
                   $con=mysqli_connect('localhost','root','','groupescolaire');
                  ...
                  ?> <center>
                    <a href="cool/<?php echo $rows['pdf'];?>" style="text-decoration: none;"><i class="fa fa-file-pdf-o" aria-hidden="true" style="color: red;"></i></a></center>
                  </div>
               </div>
             </div>
             <div class="col-sm-4">
               <div class="panel panel-success">
                 <div class="panel-heading"><h4><center>Réglement intérieur</center></h4></div>
                  <div class="panel-body">
                   <center>
                             <?php
                               $con=mysqli_connect('localhost','root','','groupescolaire');
                            ...
                            ?>
                            <a href="cool/<?php echo $rows['pdf'];?>" style="text-decoration: none;"><i class="fa fa-file-pdf-o" aria-hidden="true" style="color: red;"></i></a>
                            <?php }?>
                   </center>
                  </div>
