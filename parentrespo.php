          ...
          <nav class="navbar navbar-fixed-top">
              <div class="container">
                  ...
                  <ul class="nav navbar-nav pull-left">
                          ...
                          <li ><a href="bdinscri.php" id="i8">Les inscris</a></li>
                          <li ><a href="contrespo.php" id="i8">Contact</a></li>
                          <li ><a href="parentrespo.php" id="i7">Parents</a></li>
                    </ul>
                   ...
                   <thead>
                    ...
                    <tbody>
                       <?php
                         ...
                         $sql="SELECT * FROM logparent";
                         $res=mysqli_query($con,$sql);
                         
                         while($rows=mysqli_fetch_array($res)) {
                          $id=$rows['id'];
                          echo "<tr>";
                          echo"<td>".$rows['name']."</td><td>".$rows['mail']."</td><td>".$rows['phone']."</td><td>".$rows['message']."</td><td>";
                         echo "<a href='supprimer/supbdparent.php?id=$id'>x</a>";
                         echo "</td></tr>";
                         }
                      ?>
                 </tbody>
